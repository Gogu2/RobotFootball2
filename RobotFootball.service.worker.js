...
/** @type {string} */
const CACHE_VERSION = '1769764293|10902898897';
/** @type {string} */
const CACHE_PREFIX = 'RobotFootball-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'RobotFootball.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["RobotFootball.html","RobotFootball.js","RobotFootball.offline.html","RobotFootball.icon.png","RobotFootball.apple-touch-icon.png","RobotFootball.audio.worklet.js","RobotFootball.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["RobotFootball.wasm","RobotFootball.pck"];
